    ...
    <footer className="border-t border-slate-200 bg-slate-50 py-24 md:py-32 relative overflow-hidden flex items-center justify-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-sm font-medium text-slate-800">
              Department of Mathematics, School of Advanced Sciences & The QuantumPlators Club, VIT Chennai
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 text-xs font-mono text-slate-500">
          <p>© 2026 Department of Mathematics, School of Advanced Sciences & The QuantumPlators Club — VIT Chennai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
