export default function Footer() {
  return (
    <footer className="border-t border-quantum-border/60 bg-[#020204] py-24 md:py-32 relative overflow-hidden flex items-center justify-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          
          {/* Column 1: Branding, Location & Disclaimer (5 cols on desktop) */}
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-sm font-medium text-quantum-text">
              VIT Chennai × The QuantumPlators Club
            </p>
            <p className="text-xs text-quantum-text-secondary leading-relaxed max-w-md">
              MG Auditorium, Vellore Institute of Technology, Vandalur-Kelambakkam Road, Keelakottaiyur, Chennai, Tamil Nadu 600127.
            </p>

            <div className="pt-3">
              <p className="text-[11px] text-quantum-text-secondary/70 leading-relaxed font-mono max-w-md">
          ...
          {/* Column 2: Event Directory (2 cols on desktop) */}
          <div className="lg:col-span-2">
            <h4 className="font-heading font-semibold text-white text-xs uppercase tracking-wider mb-4">
              Directory
            </h4>
            <ul className="space-y-2.5 text-xs text-quantum-text-secondary">
              <li>
              ...
              <li>
                <a href="#schedule" className="hover:text-white hover:underline transition-colors">5-Day Schedule</a>
              </li>
              <li>
                <a href="#venue" className="hover:text-white hover:underline transition-colors">Venue & Transit</a>
              </li>
              <li>
                <a href="#organizers" className="hover:text-white hover:underline transition-colors">Organizers</a>
              </li>
            </ul>
          </div>

          {/* Column 3: Hackathon & Support (2 cols on desktop) */}
          <div className="lg:col-span-2">
            <h4 className="font-heading font-semibold text-white text-xs uppercase tracking-wider mb-4">
              Hackathon
            </h4>
            <ul className="space-y-2.5 text-xs text-quantum-text-secondary">
              <li>
                <a href="#hackathon" className="hover:text-white hover:underline transition-colors">Challenge Tracks</a>
              </li>
              <li>
                <a href="#speakers" className="hover:text-white hover:underline transition-colors">Mentors Lineup</a>
              </li>
              <li>
                <a href="#faq" className="hover:text-white hover:underline transition-colors">FAQs & OD Info</a>
              </li>
              <li>
                <a href="#get-involved" className="hover:text-white hover:underline transition-colors">Partner With Us</a>
              </li>
              <li>
          ...
          {/* Column 4: Resources & Global Ecosystem (3 cols on desktop) */}
        ...
        {/* Bottom Credits Bar */}
        <div className="mt-16 pt-8 border-t border-quantum-border/40 text-xs font-mono text-quantum-text-secondary/70">
