      ...
      <div className="w-full max-w-7xl mx-auto">
        <AnimatedSection>
          <SectionHeading
            ...
            subtitle="University leadership, faculty convenors, and student organizers for Qiskit Fall Fest 2026 at VIT Chennai"
          />
        </AnimatedSection>
          ...
          <AnimatedSection delay={0.16}>
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-sm text-slate-600 mt-1">
                Faculty convenors, department leadership, and student organizers for Qiskit Fall Fest 2026
              </p>
            </div>
          </AnimatedSection>
