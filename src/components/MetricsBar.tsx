...
export default function MetricsBar() {
  return (
    <section className="py-20 md:py-36 lg:py-44 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-y border-quantum-border/60 bg-[#0b0b12] flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left">
            <AnimatedSection>
              ...
              <p className="text-sm text-quantum-text-secondary max-w-sm mb-6 leading-relaxed">
                Opening ceremony at MG Auditorium, VIT Chennai in October 2026.
              </p>
              <EventCountdown />
            </AnimatedSection>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {stats.map((s, i) => (
                <AnimatedSection key={s.label} delay={i * 0.07}>
                  <div className="p-6 sm:p-7 rounded-2xl bg-quantum-surface/60 border border-quantum-border flex flex-col justify-between h-full">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-semibold text-quantum-text mt-1">
                        {s.label}
                      </div>
                      <div className="text-xs text-quantum-text-secondary font-mono mt-0.5">
                        {s.sub}
                      </div>
                    </div>
                  </div>
